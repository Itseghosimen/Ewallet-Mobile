    ...
    <StyledView className="flex-1 bg-white dark:bg-background px-3 gap-14 pb-5">
      ...
      <StyledView>
        <StyledView className="flex-row justify-between items-center">
          <StyledText
            className="text-secondary test-sm"
            style={{
              fontFamily: "Inter_500Medium",
            }}
          >
          ...
          {counter === 0 ? (
            <StyledText className="text-black dark:text-primary">
              {resent}
            </StyledText>
          ) : (
            <StyledText className="text-[#F80F0F]">
              Resend code in{" "}
              {new Date(counter * 60 * 1000).toISOString().substr(11, 5)}s
            </StyledText>
          )}
        </StyledView>
        <CodeField
      ...
      <StyledView>
        ...
        >
          <StyledText
            className="text-black dark:text-primary text-base "
            style={{
              fontFamily: "Inter_500Medium",
            }}
          >
