    ...
    >
      ...
      <StyledView className="bg-white dark:bg-background px-3 pt-2 h-[80vh] rounded-t-3xl">
        ...
        <StyledView className="flex-1 pt-6 pb-10">
          ...
          >
            Usernames can be used to send and Receive currencies, Recover wallet
            and find friends on Enetwallet.
          </StyledText>
          ...
          <StyledView className="pt-8 flex gap-y-2">
            ...
            <StyledView
              className="flex flex-row bg-white dark:bg-black items-center px-3 h-14 rounded-xl"
              style={{
                borderWidth: 2,
            ...
            <StyledView>
              {notAvaible && (
                <StyledText
                  className="text-xs text-red-500 dark:text-red-500"
                  style={{
                    fontFamily: "Inter_500Medium",
                  }}
                >
