...
export default function walletGenerated() {
  const layout = Dimensions.get("window").width;

  return (
    <StyledView className="flex-1 bg-white dark:bg-background px-3 pt-12 pb-5">
      ...
      <StyledText
        className="text-center mx-auto max-w-[80vw] text-2xl text-black dark:text-white mb-5"
        style={{
      ...
      <StyledTouch
        onPress={() => router.push("/createUserName")}
        className="h-14 bg-black dark:bg-primary rounded-full flex items-center justify-center"
      >
        <StyledText
