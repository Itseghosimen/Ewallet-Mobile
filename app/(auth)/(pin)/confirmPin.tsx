            ...
            <StyledView
                ...
                <StyledView
                    ...
                    <StyledText
                        ...
                        className='text-sm text-center text-black dark:text-white mx-auto'>
                        You will need this pin to login and confirm  transactions Make sure it is difficult for others to guess and easy for you to remember
                    </StyledText>
                </StyledView>
