...
export default function guadianRecovery() {
  ...
  return (
    <StyledView className="py-5 px-3 bg-white dark:bg-background flex-1">
      ...
      >
        Enter the email / Username / Address, of the guardian you want to use
        and recover your account.
      </StyledText>
      <StyledView
        className="flex flex-row bg-white dark:bg-black items-center px-3 h-14 rounded-xl mt-3"
        style={{
          borderWidth: 2,
      ...
      >
        ...
        <StyledInput
          ...
          className={`flex-grow ${
            username && "text-black dark:text-primary"
          } h-full text-base mb-1 px-3`}
          style={{
      ...
      {address && (
        <StyledView className="mt-2 flex-row items-center">
          ...
          <Image
            source={require("@/assets/icons/3dcheck.png")}
            style={{
              height: 20,
              width: 20,
            }}
      ...
      >
        <StyledText
          className={`text-base ${
            username ? "text-white dark:text-black" : "text-[#939393]"
          } `}
          style={{
            fontFamily: "Inter_500Medium",
          }}
