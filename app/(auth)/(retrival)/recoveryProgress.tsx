...
export default function recoveryProgress() {
    ...
    const redirect = () => {
        if (recovered) {
            router.push('/recoverySuccess')
        }
    }
    return (
        <StyledView className='flex-1 items-center bg-white dark:bg-background gap-y-12 pt-16 pb-5 px-3'>
            <StatusBar
            ...
            <StyledView className='flex gap-y-4 w-full'>
                ...
                <StyledTouch
                    ...
                    <StyledText className={`text-base ${recovered ? 'text-white dark:text-black' : 'text-[#49515D]'} `}
                        style={{
