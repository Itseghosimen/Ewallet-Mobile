...
export default function addGuadian() {
    ...
    return (
        <StyledView className='py-5 px-3 bg-white dark:bg-background flex-1'>
            ...
            <StyledText
                ...
                Enter the registered guardian email, that will approve your identity
            </StyledText>
            ...
            <ConfirmRecovery to={'/addedSus'} type='Add Guardians' isVisible={confirm} close={() => setConfirm(false)} />
        </StyledView>
    )
}