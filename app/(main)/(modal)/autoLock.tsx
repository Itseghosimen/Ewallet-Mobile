            ...
            <Modal
                ...
                <StyledComponent component={Pressable} className='flex-1 bg-black/80 rounded-t-3xl'>
                    ...
                    <StyledView className="pb-6 bg-white dark:bg-background rounded-t-3xl">
                        <StyledText className="text-base  text-center text-black dark:text-primary my-6"
                            style={{
                                fontFamily: 'Inter_500Medium'
                            }}>
                            Auto-Lock
                        </StyledText>
                        <StyledView className="gap-y-3 p-3 mb-3" style={{ backgroundColor: Colors[colorScheme].otpbg }}>
                            <SettingBtn
                                type='switch'
                                title='Immediately'
                                frontIcon={undefined}
