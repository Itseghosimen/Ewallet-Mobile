        ...
        <StyledView className='flex-1 bg-white dark:bg-background pt-20'>
            <StyledView className='h-[40vh] flex items-center justify-center'>
                {
                    Math.round(progress * 100) >= 0 && Math.round(progress * 100) <= 25 ?
                        ...
                        : Math.round(progress * 100) >= 25 && Math.round(progress * 100) <= 50 ?
                            <Image
                            ...
                            : Math.round(progress * 100) >= 50 && Math.round(progress * 100) <= 75 ?
                                <Image
            ...
            <StyledView className='mt-16'>
                ...
                <StyledText
                    ...
                    The encryption and security verification of your wallet is successful, Your smart wallet is currently being created to offer you the best user experience
                </StyledText>
            </StyledView>
            ...
            <StyledView className='px-3 pb-5 items-center'>
                <StyledView className='flex-row items-center justify-center flex-wrap'>
                    ...
                    >
                        {
                            Math.round(progress * 100) >= 101 ? 100 : Math.round(progress * 100)
                        }%
                    </StyledText>
                    <StyledText
                        className='text-secondary text-[13px]'
                    ...
                    >, Estimated completion time:{' '}</StyledText>
                    <StyledText
                    ...
                    >
                        {
                            progress <= 0.15 ? '2 minutes' :
                                progress >= 0.15 && progress <= 0.35 ? '1 min 30 secs' : progress >= 0.35 && progress <= 0.65 ? '1 minute' : progress >= 0.65 && progress <= 0.85 ? ' 30 seconds' : '10 seconds'
                        }
                    </StyledText>
                </StyledView>
                <Progress.Bar
