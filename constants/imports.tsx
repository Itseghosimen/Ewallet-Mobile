...
export const TokenPron = (props: { icon: ImageSource | ImageSource[]; abbreviation: string; fullName: string; rate: number; dollar: number; }) => {
    return (
        <Link
            href={{
...
export const TokenSelect = (props: { icon: ImageSource | ImageSource[]; abbreviation: string; fullName: string; rate: number; dollar: number; }) => {
    return (
        <TouchableWithoutFeedback onPress={router.back} style={{
            width: '100%',
            paddingVertical: 10
        }}>
            <StyledView className="flex-row items-center justify-between">
